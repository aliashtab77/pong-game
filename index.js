...
function creatBall(x, y, radius, velocityX, velocityY, color){
...
const ball = creatBall(canvas.width / 2, canvas.height / 2, ballRadius, initialBallSpeed, initialBallSpeed, "AQUA");
...
function render(){
    ...
    drawText(user.score, canvas.width / 4, canvas.height / 2, "BLUE", 120, 'bold');
    drawText(com.score, (3 * canvas.width) / 4 , canvas.height / 2, "RED", 120, 'bold');
